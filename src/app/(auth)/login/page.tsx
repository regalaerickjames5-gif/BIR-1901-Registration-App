      ...
      <div className="w-full max-w-md bg-slate-800/40 border border-slate-700 backdrop-blur-xl p-8 sm:p-10 rounded-2xl shadow-2xl relative overflow-hidden mt-32 mx-auto flex-1 flex items-center justify-center">
        ...
        <div className="w-full">
          <div className="text-center mb-10">
            <div className="w-16 h-16 bg-[var(--color-bir-yellow)] rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
              <span className="text-[var(--color-bir-blue)] font-extrabold text-3xl">B</span>
            </div>
            <h2 className="text-3xl font-bold mb-2 text-white">Welcome Back</h2>
            <p className="text-slate-400">Log in to continue your Form 1901 draft</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <button 
              type="submit" 
              className="w-full bg-[var(--color-bir-yellow)] text-[var(--color-bir-blue)] font-bold py-3 rounded-lg hover:bg-yellow-300 transition-colors shadow-lg"
            >
              Log In
            </button>
          </form>
